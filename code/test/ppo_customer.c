...
int main() {
	...
	cashierMoney = CreateMonitor("CashMoney", 9, 100);
	passportClerkMoney = CreateMonitor("PpClerkMoney", 12, 100);
	...
	passportClerkStates = CreateMonitor("PpClerkStates", 13, 100);
	...
	appRegularLineCVs = CreateMonitor("AppClerkRegCV", 13, 100);
	appTransactionCVs = CreateMonitor("AppClerkTransCV", 15, 100);
	appTransactionLocks = CreateMonitor("AppClerkTransLock", 17, 100);
	appBreakCVs = CreateMonitor("AppClerkBreakCV", 15, 100);
	customerAppDoneList = CreateMonitor("CustAppDoneList", 15, 100);

	picClerkIndexLock = CreateLock("PicClerkIndexLock", 17);
	picLineLock = CreateLock("PicClerkLineLock", 16);
	picRegularLineCVs = CreateMonitor("PicClerkRegCV", 13, 100);
	picBribeLineCVs = CreateMonitor("PicClerkBribeCV", 15, 100);
	picTransactionCVs = CreateMonitor("PicClerkTransCV", 15, 100);
	picTransactionLocks = CreateMonitor("PicClerkTransLock", 17, 100);
	...
	picCustomerIndex = CreateMonitor("PicCustIndex", 12, 100);
	customerPicDoneList = CreateMonitor("CustPicDoneList", 15, 100);

	passportClerkIndexLock = CreateLock("PpClerkIndexLock", 16);
	passportLineLock = CreateLock("PpClerkLineLock", 15);
	passportRegularLineCVs = CreateMonitor("PpClerkRegCV", 12, 100);
	passportBribeLineCVs = CreateMonitor("PpClerkBribeCV", 14, 100);
	passportTransactionCVs = CreateMonitor("PpClerkTransCV", 14, 100);
	passportTransactionLocks = CreateMonitor("PpClerkTransLock", 16, 100);
	passportBreakCVs = CreateMonitor("PpClerkBreakCV", 14, 100);
	passportBribeMonitorIndex = CreateMonitor("PpBribeLineNum", 14, 1);
	passportRegularMonitorIndex = CreateMonitor("PpRegLineNum", 12, 1);
	passportMonitorIndex = CreateMonitor("PpClerkCount", 12, 100);
	passportCustomerIndex = CreateMonitor("PpCustIndex", 11, 100);
	customerPassportDoneList = CreateMonitor("CustPpDoneList", 14, 100);

	cashierIndexLock = CreateLock("CashIndexLock", 13);
	cashierLineLock = CreateLock("CashLineLock", 12);
	cashierRegularLineCVs = CreateMonitor("CashRegCV", 9, 100);
	cashierTransactionCVs = CreateMonitor("CashTransCV", 11, 100);
	cashierTransactionLocks = CreateMonitor("CashTransLock", 13, 100);
	cashierBreakCVs = CreateMonitor("CashBreakCV", 11, 100);
	cashierRegularMonitorIndex = CreateMonitor("CashRegLineNum", 14, 100);
	cashierMonitorIndex = CreateMonitor("CashClerkCount", 14, 100);
	cashierCustomerIndex = CreateMonitor("CashCustIndex", 13, 100);
	customerCashierDoneList = CreateMonitor("CustCashDoneList", 16, 100);
